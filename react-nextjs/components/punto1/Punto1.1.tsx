    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", width: "80%" }}>
            <AccordionPersonal title="A) Seguridad del entorno de desarrollo">
                ...
                <div>En este proyecto, los procesos de revisión y pruebas se manejan de la siguiente manera:</div>
                <ul>
                ...
                <div>En este proyecto, la gestión de la configuración y el control de versiones se maneja utilizando la metodología gitflow, que tiene las siguientes fases:</div>
                <ul>
